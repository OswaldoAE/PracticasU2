...
new Vue({
    ...
    mounted() {
        ...
        setTimeout(() => {
            this.memorama.forEach((fila, indiceFila) => {
                fila.forEach((carta, indiceImagen) => {
                    this.$set(this.memorama[indiceFila], indiceImagen, { ...carta, mostrar: true });
                });
            });
            ...
            setTimeout(() => {
                this.memorama.forEach((fila, indiceFila) => {
                    fila.forEach((carta, indiceImagen) => {
                        this.$set(this.memorama[indiceFila], indiceImagen, { ...carta, mostrar: false });
                    });
                });
            }, SEGUNDOS_ESPERA_VOLTEAR_IMAGEN * 3000);
        }, 2000); 
    },
